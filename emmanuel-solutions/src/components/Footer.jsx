...
export function Footer() {
  ...
  return (
    <footer className="footer">
      <m.div className="footer-container"
        initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}
      >
        <m.div className="footer-section" custom={0} variants={fadeUp}>
        ...
        <m.div className="footer-section" custom={3} variants={fadeUp}>
          <h5>Contact</h5>
          <ul>
        ...
        <m.div className="footer-bottom" custom={4} variants={fadeUp}>
        ...
        <m.div className="footer-accreditations" custom={5} variants={fadeUp}>
