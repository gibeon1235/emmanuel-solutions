    ...
    <div className="page cs-page" data-study={caseStudyId}>
      ...
      <div className="cs-hero">
        ...
        <div className="cs-hero__inner">
          <m.div className="breadcrumb cs-breadcrumb"
          ...
          <m.div className="cs-hero__eyebrow" variants={fadeUp} initial="hidden" animate="visible">
            Case Study · {SERVICE_LABELS[detail.service] || detail.service}
          </m.div>

          <m.div className="cs-hero__logo" variants={fadeUp} custom={1.5} initial="hidden" animate="visible">
            {detail.brandName}
          </m.div>

          <m.h1 className="cs-hero__product" variants={fadeUp} custom={2} initial="hidden" animate="visible">
            {detail.productName}
          </m.h1>

          <m.p className="cs-hero__tagline" variants={fadeUp} custom={2.5} initial="hidden" animate="visible">
            {detail.tagline}
          </m.p>
      ...
      <main className="cs-main">
          ...
          <div className="cs-section__inner cs-split">
            ...
            >
              ...
              {detail.challenge.body.map((p, i) => (
                <m.p key={i} variants={fadeUp} custom={i + 1}>{p}</m.p>
              ))}
            </m.div>
            ...
            <div className="cs-product-grid">
              <div className="cs-product-text">
                {detail.product.body.map((p, i) => (
                  <m.p key={i} variants={fadeUp} custom={i + 1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                    {p}
                  </m.p>
                ))}
              </div>
              <div className="cs-pillars">
                {detail.product.pillars.map((p, i) => (
                  <m.div className="cs-pillar" key={i} variants={fadeUp} custom={i + 1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <div className="cs-section__inner">
            ...
            <div className="cs-tech-grid">
              {detail.technology.pillars.map((t, i) => (
                <m.div className="cs-tech-card" key={i} variants={fadeUp} custom={i + 1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                  <h3>{t.title}</h3>
                  <p>{t.desc}</p>
                </m.div>
              ))}
        ...
        <section className="cs-section cs-impact-section">
          ...
          <div className="cs-section__inner cs-impact-inner">
            <m.div className="cs-impact-label" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              Farmer Impact
            </m.div>
            <m.div className="cs-impact-number" variants={fadeUp} custom={1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              {detail.impact.headline}
            </m.div>
            <m.p className="cs-impact-sub" variants={fadeUp} custom={2} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              {detail.impact.subline}
            </m.p>
            <div className="cs-impact-outcomes">
              {detail.impact.outcomes.map((o, i) => (
                <m.div className="cs-outcome" key={i} variants={fadeUp} custom={i + 3} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <div className="cs-section__inner">
            ...
            <div className="cs-scale-grid">
              {detail.scale.map((s, i) => (
                <m.div className="cs-scale-card" key={i} variants={fadeUp} custom={i + 1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            {detail.globalCustomers && (
              <m.div className="cs-customers" variants={fadeUp} custom={4} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <div className="cs-section__inner" style={{ paddingTop: "4rem", paddingBottom: "4rem" }}>
            <div className="contact-container">
              <div className="contact-header">
                <m.h2 style={{ color: "#fff" }} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                  Explore How We Can Work Together
                </m.h2>
                <m.p className="contact-intro" variants={fadeUp} custom={1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="detail-cta-buttons">
                <a
                  href={`mailto:isaac@emmanuelsolutionss.com?subject=Enquiry: ${detail.title}`}
