...
// ── THE EMMANUEL SOLUTIONS GROUP (Divisions) ──────────────
// IIF & SFAI: placeholder content — swap in real material
// from Prasanna (IIF) and Prashant (SFAI) when received.
// Search for "PLACEHOLDER" to find every spot to update.
...
export const divisions = [
  {
    ...
    name: "AI Solutions",
    status: "Now Live",
    tagline: "Practical AI for real businesses — automation, intelligence, and digital presence without the hype.",
    highlights: ["Workflow automation", "AI assistants & chatbots", "Data intelligence", "AI-built digital presence"],
    comingSoon: false
  },
  {
    id: "iif",
    abbr: "IIF",
    name: "IIF", // PLACEHOLDER — full name from Prasanna
    status: "Joining the Group",
    tagline: "A specialist practice joining the Emmanuel Solutions group — full profile coming soon.", // PLACEHOLDER
    highlights: ["Deep domain expertise", "Established industry network", "Now part of Emmanuel Solutions"], // PLACEHOLDER
    comingSoon: true
  },
  {
    id: "sfai",
    ...
    status: "Part of the Group",
    tagline: "The industry consortium promoting safe Spray Polyurethane Foam insulation for an energy-secure India — now part of Emmanuel Solutions.",
    highlights: ["Technical training programmes", "Standards & safe-use advocacy", "Insulation + air sealing expertise", "Industry consortium since 2016"],
    comingSoon: false
  }
];
...
export const divisionDetails = {
  "ai-solutions": {
    title: "AI Solutions",
    label: "Emmanuel Solutions · AI Practice",
    tagline: "We help organisations put artificial intelligence to work — practically, affordably, and with measurable results.",
    overview: [
      "Most businesses know AI matters. Far fewer know where to start. Emmanuel Solutions' AI practice closes that gap — bringing the same outside-in, needs-first philosophy that has guided our consulting for three decades to the newest and fastest-moving technology of our time.",
      "We don't sell hype. We identify the specific points in your operations where AI genuinely saves time, reduces cost, or unlocks new capability — then we build, deploy, and train your team to own it."
    ],
    approach: {
      title: "Our Approach",
      steps: [
        { label: "Discover", desc: "A structured audit of your workflows to find where AI delivers real return — not where it's merely fashionable." },
        { label: "Design", desc: "Solution design matched to your budget, data readiness, and team capability. Simple tools first; complexity only where it earns its keep." },
        { label: "Deploy", desc: "We build and integrate the solution — assistants, automations, dashboards, or digital presence — and run it alongside you until it's stable." },
        { label: "Empower", desc: "Hands-on training so your team can operate, adapt, and extend what we've built. You own the capability, not a dependency." }
      ]
    },
    focusAreas: [
      {
        title: "AI Assistants & Chatbots",
        body: "Customer-facing chatbots and internal assistants that answer questions from your own documents, qualify leads, and handle routine enquiries around the clock — in your brand's voice."
      },
      {
        title: "Workflow Automation",
        body: "Connecting the tools you already use so repetitive work — data entry, report generation, follow-up emails, invoice handling — happens automatically. Hours back, every week."
      },
      {
        title: "Data Intelligence & Dashboards",
        body: "Turning the data sitting in your spreadsheets and systems into live dashboards and plain-language insights that support faster, better decisions."
      },
      {
        title: "AI-Built Digital Presence",
        body: "Modern, fast websites and digital collateral built with AI-assisted development — delivered in days, not months, at a fraction of traditional agency cost."
      },
      {
        title: "AI Readiness & Training",
        body: "Workshops that take teams from AI-curious to AI-capable: practical prompting, tool selection, data safety, and building an internal culture that uses AI responsibly."
      },
      {
        title: "Custom AI Consulting",
        body: "For challenges that don't fit a template — we scope, prototype, and validate custom AI applications with clear success metrics before you commit serious budget."
      }
    ],
    audience: [
      "SMEs wanting AI benefits without an in-house tech team",
      "Industrial and manufacturing firms automating operations",
      "Consultancies and service firms scaling their delivery",
      "Founders needing a fast, modern digital presence"
    ]
  },

  "iif": {
    title: "IIF", // PLACEHOLDER — full name
    label: "Emmanuel Solutions Group",
    tagline: "A specialist practice joining the Emmanuel Solutions group.", // PLACEHOLDER
    comingSoon: true,
    overview: [
      "IIF is becoming part of the Emmanuel Solutions group — bringing its expertise, relationships, and track record under one roof alongside our sustainability, innovation, and AI practices.", // PLACEHOLDER
      "The full IIF profile — services, projects, and team — is being prepared and will be published here shortly." // PLACEHOLDER
    ],
    whatToExpect: [
      "Full service portfolio and areas of practice",
      "Track record, projects, and partnerships",
      "Team profiles and leadership",
      "How IIF and Emmanuel Solutions work together"
    ]
  },

  "sfai": {
    title: "Spray Foam Alliance of India",
    label: "Emmanuel Solutions Group · Industry Alliance",
    tagline: "Promoting the safe use of Spray Polyurethane Foam across India's building, construction, and cold chain industries — now part of the Emmanuel Solutions group.",
    overview: [
      "The Spray Foam Alliance of India (SFAI) was born at a defining moment — when polyurethane industry stalwarts came together to change the game in alignment with consumer needs, going beyond the capacity and skill limitations of individual enterprises. Launched in May 2016 as a consortium of system houses and technical experts, SFAI has since led India's conversation on Spray Polyurethane Foam (SPF).",
      "SPF's advantages are uniquely suited to India, where the business case for insulation is still being proven: it achieves both insulation and air sealing in a single stroke. SFAI believes skill development for SPF is the vital cog that should not be left to a handful of enterprises — which is why training, standards, and safety sit at the heart of everything the alliance does.",
      "As part of the Emmanuel Solutions group, SFAI's technical depth now connects directly with the group's sustainability advisory, circular economy, and innovation practices."
    ],
    mission: "To promote the safe use of Spray Polyurethane Foam in the building & construction and cold chain industries — in collaboration with stakeholders and government energy-conservation policy makers — and impart technical training thereto.",
    vision: "To ensure an energy-secure India through Spray Polyurethane Foam insulation.",
    focusAreas: [
      {
        title: "Technical Training Programmes",
        body: "Hands-on SPF training for engineers, consultants, applicators, and entrepreneurs — delivered with partners including Graco's Technical Centre (Gurugram) and Covestro (Noida). Past programmes have drawn participants from as far as Raipur and Ladakh."
      },
      {
        title: "Standards & Safe Use",
        body: "Contributing to the Indian Standard code of practice for spray-applied insulation, and championing health & safety in SPF chemistry, application, and handling across the industry."
      },
      {
        title: "Building & Construction Insulation",
        body: "Advocacy and technical guidance on why, where, and how to insulate — connecting SPF's insulation-plus-air-sealing advantage to India's energy conservation goals and architectural practice."
      },
      {
        title: "Cold Chain & Retrofit Applications",
        body: "Special focus on retrofitting SPF for cold stores and cold chain infrastructure — a direct link to the group's post-harvest and food security work."
      },
      {
        title: "Technical Resources & Knowledge Base",
        body: "A library of technical articles, manuals, standards, and videos — from PU Magazine contributions to the SFAI Manual — supporting continuous learning across the SPF ecosystem."
      },
      {
        title: "Industry Events & Convening",
        body: "Bringing the ecosystem together through training events and industry gatherings such as ICE 2017 (Chennai Trade Centre) and technical programmes across Pune, Indore, Noida, and Gurugram."
      }
    ],
    audience: [
      "Applicators and contractors building SPF capability",
      "Architects and consultants specifying insulation",
      "Cold chain and warehousing operators",
      "System houses and material suppliers"
    ]
  }
};
