      ...
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <nav className="nav-desktop">
            ...
            {/* Group dropdown — divisions of Emmanuel Solutions */}
            <div className="nav-group"
              onMouseEnter={() => openMenu("group")}
              onMouseLeave={() => closeMenu("group")}
            >
              <button className="nav-link dropdown-trigger">
                The Group <span className="chevron">▼</span>
              </button>
              <AnimatePresence>
                {openDropdown === "group" && (
                  <motion.div className="dropdown-menu"
                    ...
                    onMouseLeave={() => closeMenu("group")}
                  >
                    <Link to="/group/ai-solutions" className="dropdown-item" onClick={() => setOpenDropdown(null)}>AI Solutions <span className="dropdown-badge">New</span></Link>
                    <Link to="/group/iif"          className="dropdown-item" onClick={() => setOpenDropdown(null)}>IIF <span className="dropdown-badge badge-soon">Soon</span></Link>
                    <Link to="/group/sfai"         className="dropdown-item" onClick={() => setOpenDropdown(null)}>SFAI <span className="dropdown-badge">New</span></Link>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
              ...
              <AnimatePresence>
                {openDropdown === "engage" && (
                  ...
                  >
                    ...
                    <a href="mailto:isaac@emmanuelsolutionss.com" className="dropdown-item">Direct Email ↗</a>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="mobile-menu-content">
              ...
              <p className="mobile-section-label">The Group</p>
              <Link to="/group/ai-solutions" onClick={closeMobile} className="mobile-nav-link">AI Solutions</Link>
              <Link to="/group/iif"          onClick={closeMobile} className="mobile-nav-link">IIF</Link>
              <Link to="/group/sfai"         onClick={closeMobile} className="mobile-nav-link">SFAI</Link>
              <hr className="mobile-divider" />
              ...
              <a href="mailto:isaac@emmanuelsolutionss.com" className="mobile-nav-link">Direct Email ↗</a>
            </div>
          </motion.nav>
        )}
      </AnimatePresence>
