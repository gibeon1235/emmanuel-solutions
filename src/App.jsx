...
import {
  services, caseStudies, team, insights, galleryImages, heroStats, divisions
} from "./data/content";
  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="home" className="hero">
          <div className="hero-content">
            ...
            <motion.h1 initial="hidden" animate="visible" custom={1.5} variants={fadeUp}>
              Transforming Industries.<br /><span className="gradient-text">Sustaining the Future.</span>
            </motion.h1>
        ...
        {/* THE GROUP ──────────────────────────────── */}
        <div className="section-alt group-section" id="group">
          <motion.section className="section"
            variants={reveal} initial="hidden" whileInView="visible"
            viewport={{ once: true, amount: 0.1 }}
          >
            <div className="section-label">The Emmanuel Solutions Group</div>
            <motion.h2 variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              One Group. Three Ways to Move You Forward.
            </motion.h2>
            <motion.p className="section-intro" variants={fadeUp} custom={1} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              Emmanuel Solutions is growing into a group of specialist practices —
              each with its own depth, all sharing one standard of work.
            </motion.p>
            <div className="grid three division-grid">
              {divisions.map((division, idx) => (
                <DivisionCard key={division.id} division={division} index={idx + 1} />
              ))}
            </div>
          </motion.section>
        </div>
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/group/:divisionId"          element={<DivisionDetailPage />} />
        {/* Catch-all → home */}
        <Route path="*"                      element={<HomePage />} />
      </Routes>
    </>
